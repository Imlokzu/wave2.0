...
if (typeof window === 'object') {
  ...
  versionChannel.addEventListener('message', event => {
    ...
    if (!version) return;
    if (semverCompare("12.0.20", version) === -1) {
...
/******/ 			return "" + chunkId + "." + {"vendors-node_modules_tauri-apps_api_core_js":"fcc6eef47d3bd9e6683e","src_config_ts-src_util_schedulers_ts":"fd3526f38a533b6aa687"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=src_serviceWorker_index_ts.3df9b92e3289e659e60f.js.map